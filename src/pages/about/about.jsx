  ...
  maskot = [
    ...
    },
    {
      ...
      info: (
        ...
        <p>
          <strong>Я часто говорю следующие фразы:</strong><br />
          «Я сейчас очень злюсь», «Меня все бесят».
        </p>
      </>
      ),
    ...
    },
    {
      ...
      info: (
        ...
        <p>
          <strong>Я часто говорю следующие фразы:</strong><br />
          «Я чувствую тревогу», «Я беспокоюсь», «Я волнуюсь».
        </p>
      </>
      ),
    ...
    },
    {
      ...
      info: (
        <>
        <p>
          Я — <span className='black-mars'>ИСКРА</span>. И я так выгляжу, когда испытываю грусть. Мне хочется полежать и поплакать.
        </p>
        <p>
          <strong>Мои отличительные черты:</strong><br />
          расстроенная и пессимистичная.
        </p>
        <p>
          <strong>Я часто говорю следующие фразы:</strong><br />
          «Мне печально».
    ...
    },
    {
      ...
      info: (
        <>
        <p>
          Я — <span className='black-mars'>ИСКРА</span>. И я так выгляжу, когда скучаю. Мне хочется быть активной, но я не вижу вокруг себя ничего интересного.
        </p>
        <p>
          <strong>Мои отличительные черты:</strong><br />
          ощущающая безразличие и фрустрацию.
        </p>
        <p>
          <strong>Я часто говорю следующие фразы:</strong><br />
      ...
      <div className='about' id='about'>
        <div className='about-hero'>
            <div className='about-text'>
                ...
                <p>Наши психологи имеют высшее психологическое образование и используют в работе подходы с доказанной эффективностью: КПТ (когнитивно-поведенческую терапию), ACT (терапию принятия и ответственности), CFT (терапию, сфокусированную на сострадании), DBT (диалектическую поведенческую терапию) и схема-терапию. Каждый специалист с пониманием и без осуждения поможет разобраться в вашем вопросе и прийти вместе к его решению.</p>
            </div>
      ...
      <div className='pluses'>
          ...
          <div className='pluses-grid'>
            ...
            <div className='pluses-card'>
              ...
              <p className='pluses-text'>Мы с пониманием и принятием поможем разобраться в вашем вопросе и прийти вместе к его решению</p>
            </div>

            <div className='pluses-card'>
              <p className='pluses-title'>Команда профессионалов</p>
              <p className='pluses-text'>Специалисты центра имеют высшее психологическое образование и квалификацию по доказательным методикам</p>
            </div>
            <div className='pluses-card'>
              <p className='pluses-title'>Транспортная доступность</p>
              <p className='pluses-text'>В 10-15 минутах от нашей локации находится автобусная, троллейбусная и трамвайная остановка, а также станция метро</p>
            </div>
          </div>
